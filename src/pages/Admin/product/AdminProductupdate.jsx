...
const AdminProductupdate = () => {
    ...
    const getInputdata = (e) => {
        ...
        if (name === "pic" && picError === "") {
            ...
            // let value =e.target.files[0]      // in case or real Backend
        ...
        seterrorMassage({ ...errorMassage, [name]: name === "pic" ? picError : FormValidator(e) })
        ...
        <div className="container-fluid my-4">
            <div className="row">
                ...
                <div className="col-lg-9">
                    <h5 className="bg-primary text-center p-2 text-light">Update Product <Link to="/admin/product" > <i className="bi bi-arrow-left text-light fs-5 float-end"> </i></Link></h5>
                                ...
                                <div>
                                    {
                                        data.pic?.map((item, index) => {
                                            ...
                                            return <img key={index}
                                                ...
                                                src={`${import.meta.env.VITE_APP_IMAGE_SERVER}${item}`} height={80} width={80} className="m-1" />
                                        })
                                    }
                                </div>
                            </div>
