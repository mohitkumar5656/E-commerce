...
import { getFaq, updateFaq } from "../../../Redux/ActionCreaters/FaqAction"
...
const AdminFaqupdate = () => {
    ...
    const postdata = (e) => {
        ...
        if (error)
            ...
            let item = FaqStatedata.find(x => x.id !== id && x.question?.toLowerCase() === data.name?.toLowerCase())
            if (item) {
    ...
    useEffect(() => {
        (() => {
            ...
            if (FaqStatedata.length) {
                const item = FaqStatedata.find(x => x.id === id)
                if (item)
                    setdata({ ...data, ...item })
                else
                    navigate("/admin/faq")
        ...
        <div className="container-fluid my-4">
            <div className="row">
                ...
                <div className="col-lg-9">
                    <h5 className="bg-primary text-center p-2 text-light">Update Faq<Link to="/admin/faq" > <i className="bi bi-arrow-left text-light fs-5 float-end"> </i></Link></h5>
                    <form onSubmit={postdata}>
                        <div className="row">
                            <div className="col-12 mb-3">
                                <label>Question</label>
                                <input type="text" name="question" value={data.question} onChange={getInputdata} placeholder="Question"
                            ...
                            <div className="col-12 mb-3">
                                <label>Answer</label>
                                <textarea name="answer" value={data.answer} onChange={getInputdata} placeholder="Short Description" rows={3}
