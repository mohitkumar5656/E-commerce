...
import { getMaincategory, updateMaincategory } from "../../../Redux/ActionCreaters/MaincategoryAction"
...
const AdminMaincategoryupdate = () => {
    ...
    const getInputdata = (e) => {
        ...
        const value = name === "pic" ? "maincategory/" + e.target.files[0].name : e.target.value
    ...
    const postdata = (e) => {
        ...
        if (error)
            ...
            if (item) {
                seterrorMassage({ ...errorMassage, name: "Maincategory With This Already Exist" })
                setshow(true)
                return
            }
            else {
        ...
        <div className="container-fluid my-4">
            <div className="row">
                ...
                <div className="col-lg-9">
                    <h5 className="bg-primary text-center p-2 text-light">Update Maincategory <Link to="/admin/maincategory" > <i className="bi bi-arrow-left text-light fs-5 float-end"> </i></Link></h5>
                    <form onSubmit={postdata}>
                        <div className="row">
                            <div className="col-12 mb-3">
                                <label>Name</label>
                                <input type="text" name="name" value={data.name} onChange={getInputdata} placeholder="Maincategory name "
