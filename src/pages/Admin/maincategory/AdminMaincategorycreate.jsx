...
import { getMaincategory, createMaincategory } from "../../../Redux/ActionCreaters/MaincategoryAction"
        ...
        <div className="container-fluid my-4">
            <div className="row">
                ...
                <div className="col-lg-9">
                    <h5 className="bg-primary text-center p-2 text-light">Create Maincategory <Link to="/admin/maincategory" > <i className="bi bi-arrow-left text-light fs-5 float-end"> </i></Link></h5>
                    <form onSubmit={postdata}>
                        <div className="row">
                            <div className="col-12 mb-3">
                                <label>Name</label>
                                <input type="text" name="name" onChange={getInputdata} placeholder="Maincategory name "
