...
import { getUser, createUser } from "../../../Redux/ActionCreaters/UserAction"
...
const AdminUsercreate = () => {
    ...
    const postData = (e) => {
        ...
        if (error)
            ...
            const item = UserStatedata.find(x =>
        ...
        <div className="container-fluid my-4">
            <div className="row">
                ...
                <div className="col-lg-9">
                    <h5 className="bg-primary text-center p-2 text-light">Create User <Link to="/admin/user" > <i className="bi bi-arrow-left text-light fs-5 float-end"> </i></Link></h5>
